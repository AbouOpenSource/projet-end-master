...
% Liens vers les artefacts publiés avant la préparation du PDF final.
\newcommand{\fichiergithub}[2]{\href{https://github.com/AbouOpenSource/projet-end-master/blob/be691b42772e9d223b1304fae597ba13ac62d505/#1}{\nolinkurl{#2}}}
\begin{document}
...
\begin{center}
    \parbox[c][\textheight][t]{\textwidth}{
        \begin{center}
            \vspace*{1.5cm}
            \includegraphics[width=0.42\textwidth]{logos/logo_cnam.png}\\
            \vspace{0.8cm}
...
\makeatother
\begingroup
\renewcommand{\baselinestretch}{1.05}\footnotesize\selectfont
\input{chapitres/Glossaire.tex}
\endgroup
\makeatletter
\@openrighttrue
\makeatother
...
% Chapitres
\input{chapitres/Chapitre_1_Introduction.tex}

\input{chapitres/Chapitre_2_Etat_De_L_Art.tex}

\input{chapitres/Chapitre_3_Methodologie.tex}

\input{chapitres/Chapitre_4_Architecture_Cible.tex}

\input{chapitres/Chapitre_5_Discussion.tex}

\input{chapitres/Chapitre_6_Conclusion.tex}
...
\input{chapitres/Annexe_I_Matrice_GitHub.tex}
\input{chapitres/Annexe_III_Reproduction_Allocation.tex}
%---------------------------------------------------------------------------
\end{document}
