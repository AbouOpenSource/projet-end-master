...
Qlib \citep{githubQlib} & MIT & 23/07/2026 & docs, tests & \href{https://github.com/microsoft/qlib/blob/main/SECURITY.md}{SECURITY.md} & Brique quantitative documentée. \\
Lean \citep{githubLean} & Apache-2.0 & 28/08/2026 & README, Tests & À vérifier & Moteur actif ; audit des données. \\
OpenBB \citep{githubOpenBB} & AGPLv3* & 30/07/2026 & README, pytest.ini & \href{https://github.com/OpenBB-finance/OpenBB/blob/develop/SECURITY.md}{SECURITY.md} & Licence à valider juridiquement. \\
...
\noindent * OpenBB : README AGPLv3, API GitHub \texttt{NOASSERTION}. Divergence à examiner juridiquement. Relevé structuré : \fichiergithub{github_due_diligence.json}{github_due_diligence.json}.
