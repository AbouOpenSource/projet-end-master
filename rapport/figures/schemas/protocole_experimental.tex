...
% La boucle de robustesse passe sous les blocs afin de ne pas traverser le flux principal.
\draw[danger] (g.south) -- ++(0,-0.75cm)
  -| node[pos=0.5,below]{robustesse temporelle}
  ([yshift=-0.75cm]c.south) -- (c.south);
\end{tikzpicture}
\end{document}
