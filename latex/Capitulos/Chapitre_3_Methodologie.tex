...
La hierarchie documentaire est la suivante : les articles scientifiques pour les affirmations theoriques et empiriques, les textes officiels pour les obligations reglementaires, les prepublications pour les resultats recents, les documentations et depots officiels pour les fonctionnalites logicielles, puis les documentations de fournisseurs pour la provenance des donnees. Les moteurs de recherche academique facilitent le reperage, mais ne constituent pas en eux-memes des sources citees.

Le dispositif releve d'une recherche documentaire structuree completee par un prototype empirique reproductible. Le terrain documentaire est constitue des 17 fiches de solutions et des references academiques, reglementaires et techniques archivees. Le terrain empirique est constitue des series quotidiennes des quatre ETF factoriels et de SPY sur 2015--2025, puis des sorties structurees transmises a la couche agentique. L'analyse combine une lecture critique qualitative, une grille de scoring documentaire et des metriques quantitatives de performance, de risque, de turnover et de fidelite des syntheses.
